...
('c47a1123-3ed5-43fc-a67c-d5e02f8be179', 'SELECTION', '${params.text}', 'var result = {text:"We have found users for you:", users:userDataService.findUsersByProperty(null, "englishLevel", userDataService.get(context.userId, null, "englishLevel").getValue())}; result;');
